...
use Travel\Components\TicketTravel\Application\Segment\SmartTravel\Update\ArgumentResolver;
use Travel\Components\TicketTravel\Application\Segment\SmartTravel\Update\Resolver;
use Travel\Components\TicketTravel\Application\Segment\SmartTravel\Update\Responder;
use Travel\Components\TicketTravel\UI\GraphQL\Segment\Type\ConditionType;
use Travel\Components\TicketTravel\UI\GraphQL\Segment\Type\UpdateSegmentType;

final class UpdateSegmentMutation
{
    ...
    public function __invoke(array $documentation): array
    {
        return [
            ...
            'type' => new UpdateSegmentType(),
            'args' => [
                'smartFolderId' => Type::nonNull(Type::id()),
                'queryId' => Type::nonNull(Type::id()),
                'title' => Type::string(),
                'conditions' => [
                    'type' => Type::listOf(ConditionType::instance()),
